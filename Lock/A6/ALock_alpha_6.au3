...
While 1
	If $locked = 1 Then
		If WinActive("Pixelsoft Lock") = 0 Then
			WinActivate("Pixelsoft Lock")
		EndIf
	EndIf
	If $locked = 1 Then
	...
	EndIf
	If $splash = 1 Then
		SplashTextOn("Pixelsoft Lock", "locked. press p to bring up the password screen", _
